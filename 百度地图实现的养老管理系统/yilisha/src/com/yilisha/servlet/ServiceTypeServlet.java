...
public class ServiceTypeServlet extends HttpServlet {
	...
	private void getList(HttpServletRequest request,
		...
		try {
			...
			List<ServiceType> serviceTypeList = this.serviceTypeDao.findByPagination(currentPage , pageSize , m);
			int total = this.serviceTypeDao.getTotal(m);
			response.setContentType("text/html;charset=utf-8");
			//{"total":10 , "rows":[{},{}]}
			String json = "{\"total\":"+total+" , \"rows\":"+JSONArray.fromObject(serviceTypeList).toString()+"}";
