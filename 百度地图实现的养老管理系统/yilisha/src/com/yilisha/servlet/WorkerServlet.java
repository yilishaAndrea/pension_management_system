...
public class WorkerServlet extends HttpServlet {
	...
	private void getList(HttpServletRequest request,
		...
		try {
			...
			List<Worker> workerList = this.workerDao.findByPagination(currentPage , pageSize , m);
			int total = this.workerDao.getTotal(m);
			response.setContentType("text/html;charset=utf-8");
			//{"total":10 , "rows":[{},{}]}
			String json = "{\"total\":"+total+" , \"rows\":"+JSONArray.fromObject(workerList).toString()+"}";
